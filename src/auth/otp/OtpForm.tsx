                ...
                <div className="bg-[#2489B0] flex-1 p-18 flex flex-col gap-5 justify-center items-center h-full rounded-2xl">
                    ...
                    <div className="border-2 bg-white rounded-xl flex-grow justify-center items-center mx-auto px-10 py-10">
                        <div className="flex flex-col items-center justify-center my-5">
                            ...
                            <p className="w-2/3 text-center font-extralight text-base">We’ve sent a code to your email. Enter it below to continue.</p>
                        </div>
                        <div className="">
                         <Form {...form}>
                                    ...
                                    <Controller
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <InputOTP
                                                    value={field.value || ""}
                                                    onChange={field.onChange}  // ✅ now it updates RHF
                                                    maxLength={6}
                                                >
                                                    <InputOTPGroup>
